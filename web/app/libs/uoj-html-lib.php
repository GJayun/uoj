...
function become404Page() {
	...
	becomeMsgPage('<div class="text-center"><div style="font-size:233px">404</div><p>你从何而来？要到哪里去？</p></div>', '404');
}
function become403Page() {
	header($_SERVER['SERVER_PROTOCOL'] . " 403 Forbidden", true, 403); 
	becomeMsgPage('<div class="text-center"><div style="font-size:233px">403</div><p>想得美哦！</p></div>', '403');
}
...
function echoBlogTag($tag_id) {
    $tag = queryTag($tag_id);
    echo '<a class="ui label ', $tag['color'] ,' jayun_tag" href="', HTML::blog_url(UOJContext::userid(), '/archive?tag='. $tag_id) ,'">', $tag[UOJLocale::mylocale()], '</span></a>';
}
