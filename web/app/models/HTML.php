...
class HTML {
	...
	public static function div_vinput($name, $type, $label_text, $default_value, $style) {
		return '<label for="'."input-$name".'" class="control-label">'.$label_text.'</label>'
			. '<div id="'."div-$name".'" class="ui input" style="'.$style.'">'
	...
	public static function div_vtextarea($name, $label_text, $default_value, $style) {
		return '<div id="'."div-$name".'">'
			. '<label for="'."input-$name".'" class="control-label">'.$label_text.'</label>'
            . '<div id="'."text-$name".'" style="'.$style.'">'
