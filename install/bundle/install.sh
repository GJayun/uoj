...
#Set some vars
_database_password_=jxv00afjlxjvaioa2f31271
...
UOJEOF
    ...
    mysql -u root --password=$_database_password_ <../db/jayun.sql
...
initProgress(){
    ...
    service mysql start
    echo "insert into judger_info (judger_name, password) values (\"main_judger\", \"$_main_judger_password_\")" | mysql jayun -u root --password=$_database_password_
